...
# dockerize prconfig.xml before packaging
/bin/dockerize -template /opt/pega/prweb/8.5.4/WEB-INF/classes/prconfig.xml:/opt/pega/prweb/8.5.4/WEB-INF/classes/prconfig.xml

# jar package prweb.war
cd /opt/pega/prweb/8.5.4 && jar -c -v -m META-INF/MANIFEST.MF -f /usr/local/jboss-eap/standalone/deployments/prweb.war .

# dockerize JBoss standalone.xml
